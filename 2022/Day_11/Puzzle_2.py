...
#Find lcm of the test values
lcm=1

#As they're all prime just multiply them
for n in test:
  lcm = lcm * n
...
for i in range(10000):
  ...
  for j in range(len(test)):
    ...
    for k in items[j]:
      ...
      #Modify worry to make it more manageable. Take it modulo the lcm to preserve all necessary information
      new = new % lcm
