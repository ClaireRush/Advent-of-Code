...
#Make empty list to store the max y value of each rock
max_y=[]

#For each rock
for y in yss:

  #Add the biggest y values to the list
  max_y.append(y[0])

#Find necessary height
height = sorted(max_y, reverse=True)[0]

#Find new width necessary
width= (height+2)*2 +1

#Define inner boundary
inner = int(500 - (width+1)/2 +1)

#Make array to store grid
grid = np.zeros((height+3,width),int)
